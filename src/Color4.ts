 ...
 */
export default class Color4 extends VectorBase<vec4> {

  /**
   * Internal use. Do not call this manually.
   */
  public static internalParse(color: string, isFirst: boolean, tryParse?: boolean): Undef<Color4> {
    if (isFirst && (Colors as any)[color]) {
      return Color4.internalParse((Colors as any)[color], false);
    }
    let m;
    if (isFirst) {
   ...
   */
  public static parse(color: string, tryParse?: boolean): Undef<Color4> {
  ...
  * Returns whether the given 2 values are equal or not.
  ...
  constructor(r: number, g: number, b: number, a: number) {
    super();
    this.rawElements = vec4.fromValues(r, g, b, a);
  }
